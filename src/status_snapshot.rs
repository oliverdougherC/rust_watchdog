...
pub fn write_snapshot(
    ...
    let payload = SnapshotPayload {
        ...
        local_fs_warnings: state.local_fs_warnings.clone(),
        ...
        run: SnapshotRun {
            ...
            skipped_temporary: state.run_skipped_temporary,
            skipped_unstable: state.run_skipped_unstable,
            ...
            skipped_hardlinked: state.run_skipped_hardlinked,
